...
- `./FullOrder`: Modified POD-PINN, MLP, DeepONet(MLP,FNO,CNO,SA-CFNO as the trunk, MLP as the branch, span=0.5)_ **If you are the reviewer of the paper "Fast Reconstruct the Flow Field of the Main Coolant Pump in the Lead-cooled Fast Reactor by Physics-Informed Surrogate Modeling", please explore this filefolder for the code and research data related to this work.**_
