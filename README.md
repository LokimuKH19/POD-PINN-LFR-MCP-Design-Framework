...
- `./FullOrder`: Modified POD-PINN, MLP, DeepONet(MLP,FNO,CNO,SA-CFNO as the trunk, MLP as the branch, span=0.5, temporarily demo due to the coordinates order is not arranged in the excel files) **If you are the reviewer of the paper "Physics-Informed Reduced-Order Modeling for Real-Time Reconstruction of 3D Flow Fields in Lead-Cooled Fast Reactor Pumps", please explore this filefolder for the code and research data related to this work.**
